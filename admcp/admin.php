...
<div id="content">
  ...
  <div  class="quick-actions_homepage">
    <ul class="quick-actions">
      ...
      <li class="bg_lg"> <a href="uploadnews.php"> <i class="icon icon-inbox"></i>Upload Conferences/News</a> </li>
      <li class="bg_ly"> <a href="viewuploads.php"> <i class=" icon icon-th"></i>View Uploads(News) </a> </li>
      <li class="bg_ly"> <a href="eventview.php"> <i class=" icon icon-th"></i>View Uploads(Events)</a> </li>
      <li class="bg_ls"> <a href="contactmessages.php"> <i class=" icon-envelope"></i>View Messages </a> </li>
      <li class="bg_lo"> <a href="logout.php"> <i class="icon icon-share-alt"></i>Logout </a> </li>
      ...
      <div class="span6">
        <div class="widget-box">
          <div class="widget-title bg_ly" data-toggle="collapse" href="#collapseG2"><span class="icon"><i class="icon-chevron-down"></i></span>
            <h5>WELCOME TO POSON ADMIN PAGE </h5>
          </div>
          <div class="widget-content nopadding collapse in" id="collapseG2">
            <ul class="recent-posts">
              ...
              <li>
                ...
                <div class="article-post" style="font-size: 15px;"> <!--<span class="user-info"> By: john Deo / Date: 2 Aug 2012 / Time:09:27 AM </span>-->
                  <p>On this panel, you will be able to post, edit, update and delete anything concerning your website </p>
                </div>
              <!--<li>
